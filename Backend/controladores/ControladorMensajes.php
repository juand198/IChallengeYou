...
class ControladorMensajes
{
	 ...
	 */
    public function registrarMensajes($fecha,$contenido,$titulo,$idclub)
    {
        try 
        {
            ...
            $comando = "INSERT INTO ".self::NOMBRE_TABLA."(".self::IDCLUB.", ".self::CONTENIDO.",".self::FECHA.", ".self::TITULO.") VALUES (?,?,?,?)";

            $sentencia = $pdo->prepare($comando);
            // Pongo los datos en la consulta INSERT
            $sentencia->bindValue(1, $idclub,PDO::PARAM_STR);
            $sentencia->bindValue(2, $contenido,PDO::PARAM_STR);
            $sentencia->bindValue(3, $fecha,PDO::PARAM_STR);
            $sentencia->bindValue(4, $titulo,PDO::PARAM_STR);
            // Ejecuto la consulta
