...
class ControladorDatos
{
    ...
    public function registrarUsuario($usuario)
    {
        try 
        {
            ...
            $comando = "INSERT INTO ".self::NOMBRE_TABLA."(".self::NOMBRE.", ".self::APELLIDOS.", ".self::EMAIL.", ".self::TIPO.", ".self::PRIMERAVEZ.", ".self::CIUDAD.", ".self::PROVINCIA.", ".self::URLFOTO.") VALUES (?,?,?,?,?,?,?,?)";
    ...
    public function obtenerDatos($cod)
    {
		try 
		{
		    ...
		    // Sentencia SELECT
		    $comando = "SELECT p.*, e.* , c.* FROM productos as p, empresas as e, categorias as c WHERE e.cod = ?";
		    $sentencia = $pdo->prepare($comando);
